...
![运行在 Java 虚拟机之上的编程语言](../../../resources/image/Java/java-virtual-machine-program-language-os.png)
...
![](../../../resources/image/Java/JavaSeSpecifications.jpg)
...
![jdk-include-jre](../../../resources/image/Java/jdk-include-jre.png)
...
![Java程序转变为机器代码的过程](../../../resources/image/Java/java-code-to-machine-code.png)
