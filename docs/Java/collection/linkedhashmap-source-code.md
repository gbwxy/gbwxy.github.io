...
2. 支持按照元素访问顺序排序,适用于封装 LRU（Least Recently Used 缓存工具。
...
![](../../../resources/image/Java/lru-cache.png)
...
>
> ![](../../../resources/image/Java/LinkedHashMap-putval-TREEIFY.png)
...
![LinkedHashMap 和 HashMap 之间的关系](../../../resources/image/Java/map-hashmap-linkedhashmap.png)
...
![LinkedHashMap 移动元素 13 到链表尾部](../../../resources/image/Java/linkedhashmap-get.png)
...
![LinkedHashMap 删除元素 13](../../../resources/image/Java/linkedhashmap-remove.png)
...
![LinkedHashMap 中插入新元素 19](../../../resources/image/Java/linkedhashmap-after-insert-1.png)

移除的步骤很简单，查看链表首节点是否存在，若存在则断开首节点和后继节点的关系，并让首节点指针指向下一节点，所以 head 指针指向了 12，节点 10 成为没有任何引用指向的空对象，等待 GC。

![LinkedHashMap 中插入新元素 19](../../../resources/image/Java/linkedhashmap-after-insert-2.png)
