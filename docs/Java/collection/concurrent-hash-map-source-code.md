...
![Java 7 ConcurrentHashMap 存储结构](../../../resources/image/Java/java7_concurrenthashmap.png)
...
![Java8 ConcurrentHashMap 存储结构（图片来自 javadoop）](../../../resources/image/Java/java8_concurrenthashmap.png)
