...
![Spring4.x主要模块](./images/jvme0c60b4606711fc4a0b6faf03230247a.png)

**Spring5.x 版本**：

![Spring5.x主要模块](./images/20200831175708.png)

Spring5.x 版本中 Web 模块的 Portlet 组件已经被废弃掉，同时增加了用于异步响应式处理的 WebFlux 组件。

Spring 各个模块的依赖关系如下：

![Spring 各个模块的依赖关系](./images/20200902100038.png)
...
![Spring主要模块](./images/jvme0c60b4606711fc4a0b6faf03230247a.png)
...
![IoC 图解](./images/frc-365faceb5697f04f31399937c059c162.png)
...
![](./images/aspectj-advice-types.jpg)
...
![](./images/159b3d3e70dd45e6afa81bf06d09264e.png)
...
![mvc-mode1](./images/mvc-mode1.png)
