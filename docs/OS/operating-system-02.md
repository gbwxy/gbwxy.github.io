...
![内存管理主要做的事情](./images/memory-management-roles.png)
...
![内存碎片](./images/internal-and-external-fragmentation.png)
...
![伙伴系统（Buddy System）内存管理](./images/linux-buddy-system.png)
...
![伙伴系统内存浪费问题](./images/buddy-system-memory-waste.png)
...
![虚拟内存作为进程访问主存的桥梁](./images/virtual-memory.png)
...
![地址翻译过程](./images/physical-virtual-address-translation.png)
...
![分段机制下的地址翻译过程](./images/segment-virtual-address-composition.png)
...
![分段机制导致外部内存碎片](./images/segment-external-memory-fragmentation.png)
...
![分页机制下的地址翻译过程](./images/paging-virtual-address-composition.png)
...
![多级页表](./images/multilevel-page-table.png)
...
![加入 TLB 之后的地址翻译](./images/physical-virtual-address-translation-mmu.png)
...
![使用 TLB 之后的地址翻译流程](./images/page-table-tlb.png)
...
![常见的页面置换算法](./images/image-20230409113009139.png)
