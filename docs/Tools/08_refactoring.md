...
![](./pictures/image-20220311155746549.png)
...
![常见的设计模式](./pictures/system-design/basis/common-design-patterns.png)

更全面的设计模式总结，可以看 **[java-design-patterns](https://github.com/iluwatar/java-design-patterns)** 这个开源项目。

**常见的软件设计原则如下**：

![常见的软件设计原则](./pictures/system-design/basis/programming-principles.png)
...
![refractor-two-hats](./pictures/refractor-two-hats.png)
