...
![](../../../resources/image/algorithms/Max&Min-heap.png)
![](../../../resources/image/algorithms/heap-structure.png)
...
![堆的存储](../../../resources/image/algorithms/堆的存储.png)
...
![堆-插入元素-1](../../../resources/image/algorithms/堆-插入元素1.png)

> 有能力的人会逐渐升职加薪，是金子总会发光的！！！

**2.从底向上，如果父结点比该元素小，则该节点和父结点交换，直到无法交换**

![堆-插入元素2](../../../resources/image/algorithms/堆-插入元素2.png)

![堆-插入元素3](../../../resources/image/algorithms/堆-插入元素3.png)
...
![删除堆顶元素4](../../../resources/image/algorithms/删除堆顶元素4.png)

然后开始将这个石头沉入海底，不停与左右子节点的值进行比较，和较大的子节点交换位置，直到无法交换位置。

![删除堆顶元素5](../../../resources/image/algorithms/删除堆顶元素5.png)

![删除堆顶元素6](../../../resources/image/algorithms/删除堆顶元素6.png)
...
![建堆1](../../../resources/image/algorithms/建堆1.png)

将初始的无序数组抽象为一棵树，图中的节点个数为 6，所以 4,5,6 节点为叶节点，1,2,3 节点为非叶节点，所以要对 1-3 号节点进行自顶向下（沉底）堆化，注意，顺序是从后往前堆化，从 3 号节点开始，一直到 1 号节点。
3 号节点堆化结果：

![建堆1](../../../resources/image/algorithms/建堆2.png)

2 号节点堆化结果：

![建堆1](../../../resources/image/algorithms/建堆3.png)

1 号节点堆化结果：

![建堆1](../../../resources/image/algorithms/建堆4.png)
...
![堆排序1](../../../resources/image/algorithms/堆排序1.png)

取出第二个元素并堆化：

![堆排序2](../../../resources/image/algorithms/堆排序2.png)

取出第三个元素并堆化：

![堆排序3](../../../resources/image/algorithms/堆排序3.png)

取出第四个元素并堆化：

![堆排序4](../../../resources/image/algorithms/堆排序4.png)

取出第五个元素并堆化：

![堆排序5](../../../resources/image/algorithms/堆排序5.png)

取出第六个元素并堆化：

![堆排序6](../../../resources/image/algorithms/堆排序6.png)
