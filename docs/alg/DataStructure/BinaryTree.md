...
![二叉树](../../../resources/image/algorithms/%E4%BA%8C%E5%8F%89%E6%A0%91-2.png)
...
![危机百科对节点深度的定义](../../../resources/image/algorithms/image-20220119112736158.png)

### 满二叉树

对于满二叉树，除最后一层无任何子节点外，每一层上的所有结点都有两个子结点二叉树。

![](../../../resources/image/algorithms/满二叉树.jpg)

一个二叉树，如果每一个层的结点数都达到最大值，则这个二叉树就是 **满二叉树**。也就是说，如果一个二叉树的层数为 K，且结点总数是(2^k) -1 ，则它就是 **满二叉树**。如下图所示：

![满二叉树](../../../resources/image/algorithms/full-binary-tree.png)

### 完全二叉树

若设二叉树的深度为h，除第 h 层外，其它各层 (1～h-1) 的结点数都达到最大个数，第 h 层所有的结点都连续集中在最左边，这就是完全二叉树。

![](../../../resources/image/algorithms/完全二叉树.jpeg)

除最后一层外，若其余层都是满的，并且最后一层是满的或者是在右边缺少连续若干节点，则这个二叉树就是 **完全二叉树** 。

大家可以想象为一棵树从根结点开始扩展，扩展完左子节点才能开始扩展右子节点，每扩展完一层，才能继续扩展下一层。如下图所示：

![完全二叉树](../../../resources/image/algorithms/complete-binary-tree.png)
...
![](../../../resources/image/algorithms/平衡二叉树.png)
...
![斜树](../../../resources/image/algorithms/oblique-tree.png)
...
![平衡二叉树](../../../resources/image/algorithms/balanced-binary-tree.png)

### 搜索二叉树

![](../../../resources/image/algorithms/二叉搜索树.png)
...
![链式存储二叉树](../../../resources/image/algorithms/chain-store-binary-tree.png)
...
![完全二叉树的数组顺序存储](../../../resources/image/algorithms/sequential-storage.png)

大家可以试着填写一下存储如下二叉树的数组，比较一下和完全二叉树的顺序存储有何区别：

![非完全二叉树的数组顺序存储](../../../resources/image/algorithms/sequential-storage2.png)
...
![先序遍历](../../../resources/image/algorithms/preorder-traversal.png)
...
![中序遍历](../../../resources/image/algorithms/inorder-traversal.png)

二叉树的中序遍历，就是先递归中序遍历左子树，再输出根结点的值，再递归中序遍历右子树，大家可以想象成一巴掌把树压扁，父结点被拍到了左子节点和右子节点的中间，如下图所示：

![中序遍历](../../../resources/image/algorithms/inorder-traversal2.png)
...
![后序遍历](../../../resources/image/algorithms/postorder-traversal.png)
